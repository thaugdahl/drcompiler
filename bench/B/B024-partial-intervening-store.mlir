...
// B024: Partial remat — intervening store blocks remat.
// %src has two writers; rootWriteCount > 1 rejects partial remat.

module {
  func.func @partial_intervening_store() -> f32 {
...
// CHECK-LABEL: func.func @partial_intervening_store
// CHECK:         affine.for
// CHECK:         affine.for
// CHECK:         affine.for
