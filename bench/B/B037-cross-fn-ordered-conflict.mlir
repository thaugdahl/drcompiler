...
// B037: Cross-fn ordered conflict — two callees store to same global.
// @clobber writes to @g between @writer and @reader, breaking the plan.
...
// No materialization — the conflict check rejected it.
