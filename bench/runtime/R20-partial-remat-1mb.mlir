...
module {
  func.func @main() -> i32 {
    ...
    %buf = memref.alloc() : memref<131072xf64>
    %result = affine.for %rep = 0 to 200 iter_args(%outer = %cst) -> (f64) {
      affine.for %i = 0 to 131072 {
        ...
        affine.store %val, %buf[%i] : memref<131072xf64>
      }
      %inner = affine.for %j = 0 to 131072 iter_args(%acc = %cst) -> (f64) {
        %v = affine.load %buf[%j] : memref<131072xf64>
    ...
    memref.dealloc %buf : memref<131072xf64>
